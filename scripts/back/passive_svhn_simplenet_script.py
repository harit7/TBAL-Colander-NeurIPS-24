...
lst_max_num_train_pts = [50,100,250,500,1000]
lst_max_num_val_pts   = [100,250,500,1000,2500,5000]
...
mixup_params          = { "mixup_alpha": [0.2, 0.9] }

mmce_params           = { "mmce_coeff" : [0.055, 0.06] }
