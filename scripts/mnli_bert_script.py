...
model_ds_key = 'multi_nli_bert'

method = "active_learning"
root_pfx = f'{model_ds_key}_calib-v2'

base_conf                = OmegaConf.load(f'{conf_dir}/{model_ds_key}_base_conf.yaml')
#base_conf                = OmegaConf.load(f'../configs/test/{model_ds_key}_base_conf.yaml')
...
T                     = 2 # number of random seeds ( tirals)
lst_C1                = [0.25]
lst_C                 = [2]
lst_eps               = [0.05]
lst_seed_frac         = [0.2]
lst_query_batch_frac  = [0.1]
lst_max_num_train_pts = [260000] 
lst_max_num_val_pts   = [100000]
...
#global_calib_params = { "calib_val_frac" : [0.25, 0.6,0.75]}
global_calib_params = { "calib_val_frac" : [0.25]}
