...
def test_xent(conf,conf_dir,all_outs,stdout=False):
    ...
    augment_conf(conf)
    t_conf = conf['training_conf']
    t_conf['weight_decay'] = 0.001
    t_conf['learning_rate'] = 0.01
    t_conf['max_epochs'] = 10
...
def test_squentropy(conf, conf_dir, all_outs,stdout=False):
    ...
    t_conf['weight_decay'] = 0.001
    t_conf['training_conf']['learning_rate'] = 0.01
    t_conf['training_conf']['max_epochs'] = 10
...
def test_top_lbl_hb(conf,conf_dir, all_outs, stdout=False):
    conf['calib_conf']      = OmegaConf.load(f'{conf_dir}/post-hoc/top_lbl_hb_conf.yaml')
    calib_conf = conf['calib_conf']
...
def test_scaling_binning(conf,conf_dir,all_outs, stdout=False):
    conf['calib_conf']      = OmegaConf.load(f'{conf_dir}/post-hoc/scaling_binning_conf.yaml')
    calib_conf = conf['calib_conf']
    calib_conf['calib_val_frac'] = calib_val_frac
...
def test_dirichlet(conf,conf_dir,all_outs,stdout=False):
    conf['calib_conf']      = OmegaConf.load(f'{conf_dir}/post-hoc/dirichlet_conf.yaml')
    calib_conf = conf['calib_conf']
    calib_conf['calib_val_frac'] = calib_val_frac
    augment_conf(conf)
...
def test_auto_label_opt_v0(conf,conf_dir,all_outs,stdout=False):
    ...
    calib_conf['use_prev_model'] = False 
...
if __name__ == "__main__":
    ...
    base_conf['eval'] = 'full'
    base_conf['random_seed']= 0


    base_conf['method'] = method #'passive_learning' # single round
    #base_conf['method'] = 'tbal'  # multi round

    base_conf['val_pts_query_conf']['max_num_val_pts'] = 8000
