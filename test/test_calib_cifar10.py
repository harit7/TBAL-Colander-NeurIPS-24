...
def test_auto_label_opt_v0(conf,conf_dir,all_outs,stdout=False):
    ...
    calib_conf['alpha_1'] = 0.001 #/1.5 / 0.01
    calib_conf['training_conf_g']['batch_size'] = 200  # 64
...
if __name__ == "__main__":
    ...
    base_conf['eval'] = 'full'
    base_conf['random_seed']= 9


    base_conf['method'] = method #'passive_learning' # single round
    #base_conf['method'] = 'tbal'  # multi round

    base_conf['val_pts_query_conf']['max_num_val_pts'] = 10000

    base_conf['train_pts_query_conf']['max_num_train_pts'] = 10000
